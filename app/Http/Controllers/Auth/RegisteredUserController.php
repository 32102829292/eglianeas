...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $request->validate([
            ...
            'birth_date.after' => 'Please enter a realistic birth date.',
            'tin_no.required' => 'Please enter your TIN.',
            'tin_no.regex' => 'Enter a valid TIN (e.g. 123-456-789 or 123-456-789-000).',
            'mother_maiden_name.required' => "Please enter your mother's maiden name.",
