                    ...
                    @forelse ($services as $service)
                        <tr>
                            ...
                            <td data-col="Actions" class="text-end">
                                <a href="{{ route('admin.other-services.receipt', $service) }}" class="btn btn-outline btn-sm">View receipt</a>
