...
@section('title', $billing->periodTitle().' Billing Statement — Egliane Accounting Services')
...
@section('content')
    ...
    <a href="{{ $fromCollections ? route('client.collections.index') : route('client.billing.index') }}" class="back-link no-print">
        ...
        {{ $fromCollections ? 'Back to Collections & Follow-ups' : 'Back to Billing Statements' }}
    </a>
