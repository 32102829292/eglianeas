    ...
    <div class="card period-scope">
        <div class="card-head">
            ...
            @include('client.partials.quarter-selector', [
                'action' => route('client.billing.index'),
        ...
        <div class="stat-grid">
            <div class="stat-card">
                ...
                <b class="stat-value">₱{{ number_format($quarterSummary['billed'], 2) }}</b>
            </div>
            ...
            <div class="stat-card stat-warn">
                ...
                <b class="stat-value">₱{{ number_format($quarterSummary['outstanding'], 2) }}</b>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    @forelse ($billings as $billing)
                        <tr>
                            ...
                            <td data-col="Total payment" class="text-end fw-semibold">₱{{ number_format($billing->total, 2) }}</td>
                    ...
                    @empty
                        <tr><td colspan="4" class="empty-cell">No billing statements were recorded for this quarter.</td></tr>
                    @endforelse
                </tbody>
            </table>
